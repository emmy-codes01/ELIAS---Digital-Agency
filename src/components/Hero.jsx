  ...
  return (
    <section className="py-25 md:pt-48 flex flex-col justify-center items-center gap-6 md:gap-14 bg-gradient-to-r from-blue-100 via-pink-100 to-white ">
      ...
      <div className="cta flex flex-col md:flex-row justify-center items-center gap-4 md:w-[38%]">
        <a href="/" className='text-white bg-[#007bff] p-3 sm:px-14 w-full text-center rounded-2xl'> 🚀 Free Instagram Page Upgrade</a>
      ...
      {showCalendly && (
        <div className="mt-6 border rounded-lg shadow-lg p-4 bg-white">
          ...
          <InlineWidget url="https://calendly.com/hello-elias-agency/30min" />
        </div>
      )}
